function getIcon(category, code) {

    switch (category) {
        case ('day'):
            category = "openweathermap/codes/day";
            break;
        case ('night'):
            category = "openweathermap/codes/night";
            break;
        case ('tomorrowDay'):
            category = "tomorrow/day";
            break;
        case ('tomorrowNight'):
            category = "tomorrow/night";
            break;
        case ('icons'):
            category = "openweathermap/icons";
            break;
    };
    ...
    return iconsMapping[category][code];

};

// ! Credits to Basmilius
// ! Repository link: https://github.com/basmilius/weather-icons